...
func main() {
	...
	flag.BoolVar(&enableLeaderElection, "leader-elect", false,
		"Enable leader election so only one instance is active at a time.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "postgres-operator.databases.example.io",
	})
	if err != nil {
	...
	setupLog.Info("starting postgres-operator")
